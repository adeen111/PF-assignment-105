...
2  Write a program to print a message "C language is a powerful programing 
language." on screen. 
...
10 Wirte a program to convert 2.5 miles into kilometers and print the result on 
screen. (Hint: 1 mile = 1.609 kilometers)
...
Volume = 𝜋𝑅2xH    The value of 𝜋 𝑖𝑠 3.1417
 
 13 Write a program using define directive to find the area of a circle. The 
formula to find the area ofa circle is: 
Area = 𝜋𝑅2    The value of 𝜋 𝑖𝑠 3.1417

14 Write a program to convert millimeters into inches and print the result on 
screen. (Hint: 1 inch = 25.4 mm) 
 
15. Write a program to interchange values of two variables. 
 
16. Write a program to assign a value 3 to "int" type variables a, b and c using 
multiple assignment statement. Calculate the product of these numbers. 
 
17. Write a program to separate the integral and fractional parts of a 15.58971 
real number and print the result on screen. 
 
18. Write a program to assign values to variables 'vi' and 't' an compute the 
value of 's' by using the formula: 
   𝑆=𝑣𝑖∗𝑡+ 1
 2
 𝑎𝑡2 
 
19. Write a program to assign your age in a variable and find the age in months 
and days. 
...
circumstance of the circle. 
  Formula for Area of a circle = 𝜋𝑅2 
  Formula for Circumference of a circle = 2𝜋𝑅 
 
24. Write a program to input marks of five subjects of a student. Calculate the 
Total and Average marks. (Each subject has weight of 100 marks).
25. 
Write a program to input the values of three sides of a triangle and calculate 
...
28 Write a program to input values into variables a, b and c. Compute the value 
of 'disc' by using formula: disc = b2 - 4ac 

 29 Write a program to print a message if the value of variable "n" is greater 
than 100, otherwise ignore the statement. 

 30Write a program to test whether a given integer is odd or even using simple
